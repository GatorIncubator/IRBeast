...
First, check the [Issue Tracker](https://github.com/GatorEducator/IRBeast/issues) to make sure it has not already been made there. If it would be a new issue, go ahead and [raise it](https://github.com/GatorEducator/IRBeast/issues/new)! We just ask that you:
...
When making a [pull request](https://github.com/GatorEducator/IRBeast/pulls), we ask that you do the following:
* give it a descriptive title
...
* fully describes all of the changes it is proposing and succinctly states why they should be approved
* add any labels that apply to it
  * or suggest labels if you do not have permission to add them
